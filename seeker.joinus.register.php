<?php
	...
	{
		$query_select_num = $query_select_run->num_rows;
	...
	$query_id = "SELECT MAX(id) AS max FROM seeker_details";
	$query_run_id = $conn->query($query_id);
	$query_rows_id = $query_run_id->num_rows;
	$db_id = 0;
