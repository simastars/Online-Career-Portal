...
<?php 
	...
	while($query_result=$query_run->fetch_assoc())
	{
		...
		echo'	<div class="div_left">';
			...
			$query_run_exp = $conn->query($query_exp);
			$query_run_industy_type = $conn->query($query_industry_type);
			...
			$row1 = $query_run_exp->fetch_assoc();
			$row2= $query_run_industy_type->fetch_assoc();

			$query_exp_result = $row1['experience'];
			$query_industy_type_result = $row2['industry_type'];
